...
namespace DataIntegrator.Objetos
{
    public class Factura : BaseObjeto
    {
        public Factura()
        {
            oEstatus.sTabla = "tbp_DI_Facturas";
        }
        ...
        List<ConceptosFactura> _conceptos = new List<ConceptosFactura>();

        //CAMPOS PAGO
        private int _iSapDocPay = 0;
        private string _sIdTransaccion = string.Empty;
        private decimal _dMontoPago = 0;
        private string _sReferenciaPago = string.Empty;
        private string _sTipoPago = string.Empty;
        private string _sCuentaCont = string.Empty;
        private string _sTipoPagoSAP = string.Empty;
        private string _sDescTipoPagoSAP = string.Empty;
        ...
        public List<ConceptosFactura> conceptos { get { return _conceptos; } set { _conceptos = value; } }
        ...
        public int iSapDocPay { get { return _iSapDocPay; } set { _iSapDocPay = value; } }
        public string sIdTransaccion { get { return _sIdTransaccion; } set { _sIdTransaccion = value; } }
        public decimal dMontoPago { get { return _dMontoPago; } set { _dMontoPago = value; } }
        public string sReferenciaPago { get { return _sReferenciaPago; } set { _sReferenciaPago = value; } }
        public string sTipoPago { get { return _sTipoPago; } set { _sTipoPago = value; } }
        public string sCuentaCont { get { return _sCuentaCont; } set { _sCuentaCont = value; } }

        public string sTipoPagoSAP { get { return _sTipoPagoSAP; } set { _sTipoPagoSAP = value; } }
        public string sDescTipoPagoSAP { get { return _sDescTipoPagoSAP; } set { _sDescTipoPagoSAP = value; } }
    }
